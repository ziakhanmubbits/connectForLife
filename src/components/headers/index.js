...
export const Primary = ({
    ...
    return (
        <Wrapper style={[appStyles.headerStyle, { backgroundColor: defaultBackgroundColor, borderBottomColor: defaultTintColor + '20', paddingTop: sizes.statusBarHeight * .2, paddingBottom: height(2),borderBottomWidth:0 },shadow&&appStyles.shadowLight, containerStyle]}>
