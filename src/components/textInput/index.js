...
import { View, Image, StyleSheet, TouchableOpacity, ActivityIndicator, Animated,TextInput, Platform } from 'react-native'
                    ...
                    left ?
                        ...
                        customIconLeft ?
                            <Wrapper style={{ alignItems: 'center', marginLeft: sizes.marginHorizontal }}>
                                <Icons.Custom icon={customIconLeft} size={iconSizeLeft ? iconSizeLeft : sizes.icons.medium} color={iconColorLeft ? iconColorLeft : colors.appTextColor5} containerStyle={iconStyleLeft} />
                            </Wrapper>
                            :
                            iconNameLeft ?
                                <Wrapper style={{ alignItems: 'center', marginLeft: sizes.marginHorizontal }}>
                                    <Icon name={iconNameLeft} type={iconTypeLeft} size={iconSizeLeft ? iconSizeLeft : sizes.icons.medium} color={iconColorLeft ? iconColorLeft : colors.appTextColor5} iconStyle={iconStyleLeft} onPress={onPressIconLeft} />
                                </Wrapper>
                                :
                                null
                }
            ...
            <View style={{ flex: 1 }}>
                {
                    onPress ?
                        ...
                        <TextInput
                            ...
                            onFocus={onFocus}
                            autoFocus={autoFocus}
                            placeholderTextColor={placeholderTextColor ? placeholderTextColor : colors.appBgColor4}
                            secureTextEntry={secureTextEntry}
